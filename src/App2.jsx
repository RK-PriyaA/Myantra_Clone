...
const App2 = () => {
  ...
  const [data, setData] = useState(showInfo.filter((e) => e.gender === "M"));
      ...
      <nav className="top-nav">
        <div className="nav-line">
          <div className="icon-holder">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS357fHYAnvyZIqrnolaRs3MlCQO7PyKngEag&usqp=CAU" width={"50px"}></img>
          </div>
        ...
        <div className="nav-line">
          ...
          <div className="cart-holder" onClick={() => setShowCart(true)}>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRy3uoGpNntbahBhi27QPQa-tOHaTvhJv_CtpjTSsfC1Q&s" width={"40px"}></img>
